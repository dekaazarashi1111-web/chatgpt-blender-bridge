"""Publish a quiescent workspace from the trusted host (never a tool container)."""
...
def main() -> int:
    ...
    parser.add_argument("--output-dir", type=Path, required=True, help="Trusted temporary directory outside source")
    ...
    parser.add_argument("--metadata", type=Path, help="Optional trusted metadata JSON")
