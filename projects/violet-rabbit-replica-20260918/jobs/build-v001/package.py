...
for p in Path(__file__).parent.iterdir():
    if p.suffix in {'.py','.json'}:shutil.copy2(p,out/'source'/p.name)
...
sheet.paste(ref,(0,36));draw.text((20,723),'BUILD V001 | actual 3D render; appearance review pending',font=font,fill=(230,230,230))
